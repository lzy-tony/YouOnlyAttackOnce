...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval   = 100
    fps_image_path  = "/home/duanchengqi20/Patch/faster-rcnn-pytorch/img/street.jpg"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/home/duanchengqi20/Patch/faster-rcnn-pytorch/img/"
    dir_save_path   = "/home/duanchengqi20/Patch/faster-rcnn-pytorch/img_out/"
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                label, confidence, bboxes = frcnn.detect_image(image, crop = crop, count = count)
                #r_image.save("/home/duanchengqi20/Patch/faster-rcnn-pytorch/img/1.png")
