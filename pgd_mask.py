...
from util.loss import TORCH_VISION_LOSS, Faster_RCNN_COCO_loss, Faster_RCNN_loss, Original_loss_gpu, TV_loss_right
...
def train(opt):
    ...
    for epoch in range(opt.epochs):
        ...
        tensor2img(noise, f"./submission/pgd_smooth_eot_mtm_half/pgd_smooth_eot_half_2e-8_epoch{epoch}.png")
        tensor2img(mask, f"./submission/pgd_smooth_eot_mtm_half/mask.png")
