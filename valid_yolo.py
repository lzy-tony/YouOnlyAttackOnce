...
def main():
    mask = cv2.imread("./submission/pgd_smooth_eot_mtm_half/mask.png")
    ...
    with open("./datasets/loc.json",'r') as f:
        ...
        patch = torch.from_numpy(np.array(Image.open("./submission/pgd_smooth_eot_mtm_half/pgd_smooth_eot_half_2e-8_epoch1.png")).astype(np.float32))
