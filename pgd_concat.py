...
from util.loss import TORCH_VISION_LOSS, Faster_RCNN_loss, Original_loss_gpu
...
def train(opt):
    ...
    for epoch in range(opt.epochs):
        ...
        tensor2img(noise, f"./submission/pgd_concat2_yolo_ssd/pgd_concat2_yolo_ssd_epoch{epoch}.png")
        tensor2img(mask, f"./submission/pgd_concat2_yolo_ssd/mask.png")
